               ...
               <div class="m-input">
                   ...
                   <div>
                       <el-form-item label="分类" prop="cid">
                           <el-select v-model="ruleForm.cid" placeholder="请选择分类">
                               <el-option  v-for="category in categories" :label="category.category" :value="category.cid"/>
                           </el-select>
                       </el-form-item>
                   </div>
               </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getCategory(cid){
                this.$axios.get('/category/'+cid).then(res=>{
                    this.ruleForm.category = res.data.data;
                })
            },
            listCategory(){
        ...
        created() {
            ...
            if(blogId){
                this.$axios.get("/blog/"+blogId).then(res=>{
                    ...
                    _this.ruleForm.cid = blog.cid;
                    this.getCategory(_this.ruleForm.cid)
                })
            }
            _this.listCategory();
